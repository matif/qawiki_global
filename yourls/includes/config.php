...
define( 'YOURLS_DB_USER', 'qawiki' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', 'pl@123' );

/** The name of the database for YOURLS */
define( 'YOURLS_DB_NAME', 'qawiki_shorturl' );
...
define( 'YOURLS_SITE', 'http://qawiki.iserver.purelogics.info/yourls' );
...
$yourls_user_passwords = array(
	'qawiki' => 'pladmin',
	'username2' => 'pladmin'	// You can have one or more 'login'=>'password' lines
	);
