...
switch( $action ) {
    ...
    $action_type = ( isset( $_REQUEST['custom_action'] ) ? $_REQUEST['custom_action'] : '' );
    $item_id = ( isset( $_REQUEST['item_id'] ) ? $_REQUEST['item_id'] : 0 );
    $item_type = ( isset( $_REQUEST['item_type'] ) ? $_REQUEST['item_type'] : '' );
    $user_id = ( isset( $_REQUEST['user_id'] ) ? $_REQUEST['user_id'] : 0 );

		$return = yourls_add_new_link( $url, $keyword, $title, $action_type, $store_id, $item_id, $item_type, $user_id );
