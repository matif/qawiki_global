...
{
  $config['base_url']	= "http://".$_SERVER['HTTP_HOST']."/qawiki-latest/qawiki/";
  $config['public_key'] = '6LcQEsISAAAAAKrz12fq9zPnH4pAHUsIJsbvnjPL';
  $config['private_key'] = '6LcQEsISAAAAAE8xRneg5ObV9-P-8PiCwK2d7-AV';
}

$config['shorten_url']	= "http://".$_SERVER['HTTP_HOST']."/yourls/";

$config['root_dir'] = $_SERVER['DOCUMENT_ROOT'];

$config['csv_upload_path'] = $config['root_dir'].'/uploads/csv/';
...
$config['email_template_type'] = array(
  'vote',
  'answer',
  'question_approved',
  'answer_approved',
...
$config['report_fields'] = array(
  ...
  array('id' => 'unanswered_app_q'    , 'title' => 'Number of unanswered approved Questions'),
  array('id' => 'products_submitted_q', 'title' => 'Number of Products with sumbitted Questions')
);

$config['top_contributors_limit'] = 25;
$config['top_contributors_min_answer'] = 5;

function __autoload($class)
{
  if(strpos($class, 'CI_') !== 0 && file_exists(APPPATH . 'libraries/'. $class . EXT) )
  {
