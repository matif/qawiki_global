  ...
  <form action="" class="form-cont">
    ...
    <div class="row_dat">
      ...
      <div class="lbl_inpuCnt">
        <input type="text" name="item_id" class="account_med required" value="<?php echo $itemInfo['item_id']?>" />
      </div>
      <div class="clear"></div>
    </div>
    ...
    <div class="row_dat">
      ...
      <div class="lbl_inpuCnt">
        <input type="text" name="itemTitle" class="account_med required" value="<?php echo $itemInfo['title']?>" />
      </div>
      <div class="clear"></div>
    </div>
      ...
      <div class="row_dat">
        ...
        <div class="lbl_inpuCnt">
          <textarea name="itemDescription" class="account_med textarea required"><?php echo $itemInfo['description']?></textarea>
        </div>
        <div class="clear"></div>
      </div>
