...
var jcarousel_start = 2;
</script>

<?php echo $this->load->view('components/_settingsSlider', array('tray_selected_thumb' => "question_email"), true); ?>
    ...
    <div class="content_accordian">
      <div class="disp_widget">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="fl">
              <tr>                                                      
                <td valign="middle" height="77">
                  <?php echo widget_popup_banner($appearance, 'qaw-question-email-header');?>
                </td>                
              </tr>
            </table>
        ...
        <div class="content_pop">
          ...
          <div>
            I wanted to know that is this a good question, if it is a good question.
          </div>
          <div>
            Thanks in advance for your question, they are helpful <a href="javascript:;">View Question</a>.
          </div>'?>
          </span>
...
<?php echo $this->load->view("settings/functions_option",array("view"=>"question"), true)?>
