...
<script type="text/javascript">
  var jcarousel_start = 1;
</script>

<?php echo $this->load->view('components/_settingsSlider', array('tray_selected_thumb' => "answer_email"), true); ?>

<div class="lft_widget">
  <div class="content_dashboard">
    <div class="heading_section  clearfix">
      <div class="head">Answer Email Preview</div>      
    ...
    <div class="content_accordian">
      <div class="disp_widget">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="fl">
              <tr>
                <td valign="middle" height="77">
                  <?php echo widget_popup_banner($appearance, 'qaw-answer-email-header');?>
                </td>                
              </tr>
            </table>
        ...
        <div class="content_pop">
          ...
          <div class="qtn_pan normal_text"><span class="editable-text"><?php echo isset($row["sub_title"]) ? $row["sub_title"] : "Your Answer have been approved and is now live" ?></span> <a href="javascript:;"><img rel = "sub_title" width="16" class="editable-link" height="16" align="absmiddle" title="Ico Edit" alt="Ico Edit" src="<?php echo base_url() ?>images/frontend/ico_edit.png"></a></div>
          <div>
            <span class="editable-text">
              <?php echo isset($row["button_text"]) ? $row["button_text"] : '
          <div>
            Is this is a good answer?
          </div>
          <div>
            I wanted to know that is this a good question, if it is a good answer.
          </div>
          <div>
            Thanks in advance for your question, they are helpful <a href="javascript:;">View Answer</a>.
          </div>' ?>
            </span>
            <a href="javascript:;"><img width="16" rel ="button_text" height="16" align="absmiddle" class="editable-link" title="Ico Edit" alt="Ico Edit" src="<?php echo base_url() ?>images/frontend/ico_edit.png"></a>
          </div>
...
<?php echo $this->load->view("settings/functions_option", array("view" => "answer"), true) ?>
