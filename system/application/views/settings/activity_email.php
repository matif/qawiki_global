...
<?php echo $this->load->view('components/_settingsSlider', array('tray_selected_thumb' => "activity_email"), true); ?>

<div class="lft_widget">
  <div class="content_dashboard">
    <div class="heading_section  clearfix">
      <div class="head">Activity Email Preview</div>      
    </div>
    <div class="content_accordian">
      <div class="disp_widget">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="fl">
              <tr>
                <td valign="middle" height="77">
                  ...
                  <?php echo widget_popup_banner($appearance, 'qaw-activity-email-header');?>
                  
                </td>                
              </tr>
            </table>
            <table cellpadding="0" cellspacing="0" border="0" class="fr">
              <tr>
        ...
        <div class="content_pop">
          ...
          <div class="qtn_pan normal_text"><span class="editable-text"><?php echo isset($row["sub_title"])?$row["sub_title"]:"Thank you for setting up a Q&amp;A account with us. For your records your user name is, #userName"?></span>.<a href="#"><img class="editable-link" rel = "sub_title" width="16" height="16" align="absmiddle" title="Ico Edit" alt="Ico Edit" src="<?php echo base_url() ?>images/frontend/ico_edit.png"></a></div>
...
<?php echo $this->load->view("settings/functions_option",array("view"=>"activity"), true)?>
