...
<?php echo $this->load->view('components/_settingsSlider', array('tray_selected_thumb' => "question"), true); ?>

<div class="lft_widget">
  <div class="content_dashboard">
    
    <div class="heading_section  clearfix">
      <div class="head">Question Light Box</div>      
    ...
    <div class="content_accordian">      
      <div class="disp_widget">
        ...
        <div class="content_pop">
          <div>
            <span class="editable">            
              <div class="heading_edit"><span class="editable-text"><?php echo isset($this->row["title"])?$this->row["title"]:"Ask A Question"?></span><a href="javascript:;" ><img rel="title" class="editable-link" src="<?php echo base_url() ?>images/frontend/ico_edit.png" alt="Ico Edit" title="Ico Edit" width="16" height="16" align="absmiddle" /></a></div>
              <div class="qtn_pan"><span class="editable-text"><?php echo isset($this->row["sub_title"])?$this->row["sub_title"]:"Ask Your Question Below."?></span><a href="javascript:;" ><img class="editable-link" rel="sub_title" src="<?php echo base_url() ?>images/frontend/ico_edit.png" alt="Ico Edit" title="Ico Edit" width="16" height="16" align="absmiddle" /></a></div>
          </div>
