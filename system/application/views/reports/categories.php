    ...
    <?php if (count($categories)): ?>
      <?php foreach ($categories as $cat): ?>
        <tr>
          ...
          <td align="center"><?php echo $cat["qa_category_id"] ?></td>
          <td><?php echo $cat["qa_category_name"] ?></td>
          <td><a class="view-report" href="javascript:;" rel="category|<?php echo $cat["id"] ?>">View Report</a></td>
        </tr>
      <?php endforeach; ?>          
    <?php else: ?>
